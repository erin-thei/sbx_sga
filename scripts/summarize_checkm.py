...
output_report.write('Sample,Completeness,Contamination,N50,Genome_Size,GC_Content,CDS\n')
...
for file in input_reports:
    ...
    for line in filelines[1:]: # Skip header
        ...
        cds = line_list[10]
    output_report.write(f'{sample},{completeness},{contamination},{n50},{genome_size},{gc_content},{cds}\n')
